...
class EnvoimoinscherHelper
{
    ...
    public static $config_keys = array('EMC_LOGIN', 'EMC_PASS', 'EMC_KEY_TEST', 'EMC_KEY_PROD', 'EMC_ENV',
        ...
        'EMC_ADDRESS', 'EMC_COMPL', 'EMC_POSTALCODE', 'EMC_CITY', 'EMC_COUNTRY', 'EMC_TEL', 'EMC_MAIL',
        ...
        'EMC_CONTENT_AS_DESC', 'EMC_NO_FREESHIP', 'EMC_MULTIPARCEL',
        'EMC_TRACK_MODE', 'EMC_ASSU', 'EMC_INDI', 'EMC_LABEL_DELIVERY_DATE', 'EMC_MASS',
        'EMC_PICKUP_SPLIT', 'EMC_PICKUP_J1', 'EMC_PICKUP_J2', 'EMC_PP_CHRP_CHRONORELAIS',
        'EMC_PP_MONR_CPOURTOI', 'EMC_PP_MONR_DOMICILEEUROPE', 'EMC_PP_MONR_CPOURTOIEUROPE',
        'EMC_PP_SOGP_RELAISCOLIS', 'EMC_PP_UPSE_STANDARDAPDEPOT', 'EMC_PP_UPSE_STANDARDDEPOT',
        'EMC_PP_PUNT_ENTREGAENPUNTOSPACK', 'EMC_PP_PUNT_ENTREGAENPOINTSRELAIS',
    ...
    protected $tables_names = array(
        ...
        'emc_documents',
        'emc_operators',
        'emc_operators_authorized_contents',
        'emc_orders',
        'emc_orders_errors',
        'emc_orders_parcels',
    ...
    public static $tracking_urls = array(
        ...
        "UPSE_StandardDepot" =>
            "https://wwwapps.ups.com/WebTracking/track?HTMLVersion=5.0&loc=fr_FR&Requester=UPSHome&WBPM_lid=homepage%252Fct1.html_pnl_trk&track.x=Suivi&trackNums=@",
        "UPSE_StandardAPDepot" =>
            "https://wwwapps.ups.com/WebTracking/track?HTMLVersion=5.0&loc=fr_FR&Requester=UPSHome&WBPM_lid=homepage%252Fct1.html_pnl_trk&track.x=Suivi&trackNums=@",
        "UPSE_StandardEs" =>
            "https://www.ups.com/WebTracking/track?HTMLVersion=5.0&loc=es_ES&Requester=UPSHome&WBPM_lid=homepage%252Fct1.html_pnl_trk&track.x=Suivi&trackNums=@",
        "UPSE_ExpressSaverEs" =>
            "https://www.ups.com/WebTracking/track?HTMLVersion=5.0&loc=es_ES&Requester=UPSHome&WBPM_lid=homepage%252Fct1.html_pnl_trk&track.x=Suivi&trackNums=@",
     ...
     */
    public static function getPricingCode($from, $to, $parcels, $params)
    {
