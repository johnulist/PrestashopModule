					...
					<div>
						<ul class="list_question">
							<li class="noliststyle">
								<div class="response">
									<p>
										{l s='A documentation is available here:' mod='envoimoinscher'}<a href="http://ecommerce.envoimoinscher.com/wp-content/uploads/2016/08/Module-EnvoiMoinsCher-pour-PrestaShop_Guide-de-configuration-2.pdf" target="_blank" class="action_module">{l s='documentation' mod='envoimoinscher'}</a><br/>	
										{l s='A documentation is also provided about sending method:' mod='envoimoinscher'}<a href="http://ecommerce.envoimoinscher.com/wp-content/uploads/2016/08/Module-EnvoiMoinsCher-pour-PrestaShop_Guide-dexp%C3%A9dition-2.pdf" target="_blank" class="action_module">{l s='sending method' mod='envoimoinscher'}</a><br/>
							...
							<li class="noliststyle">
								<div class="subtitle closed">
									<p>
										{l s='can i ship parcel in just-in-time distribution' mod='envoimoinscher'}
									</p>
								</div>
								<div class="response">
									<div>
